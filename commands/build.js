...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (cityExists) {
            ...
            const costs = {
                plazaCost: (city.plazasBuilt + 1) * 2000,
                plazaResources: (city.plazasBuilt + 1) * 500,
                busStationCost: (city.busStationsBuilt + 1) * 3000,
                busStationResources: (city.busStationsBuilt + 1) * 800,
            }
